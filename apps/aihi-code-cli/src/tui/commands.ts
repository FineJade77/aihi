...
export const SLASH_COMMANDS: readonly SlashCommandDescriptor[] = [
  ...
  { name: "sessions", usage: "/sessions [QUERY]", description: "Search and open Sessions" },
  ...
  { name: "providers", usage: "/providers [NAME] [MODEL]", description: "List or select a Provider" },
  { name: "models", usage: "/models [PROVIDER/MODEL]", description: "List or select a Model" },
  { name: "provider", usage: "/provider [NAME] [MODEL]", description: "Provider alias" },
  { name: "model", usage: "/model [MODEL]", description: "Model alias" },
  { name: "status", usage: "/status", description: "Show Session and runtime status" },
  { name: "doctor", usage: "/doctor", description: "Run local configuration diagnostics" },
