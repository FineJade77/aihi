...
compatibility rules below and covered by the frozen corpus in
`tests/contract/test_event_compatibility.py`.
...
#: frozen corpus (`tests/contract/test_event_compatibility.py`), so adding a
#: durable type without a compatibility fixture fails the build.
