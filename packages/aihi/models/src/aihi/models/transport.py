...
class HttpxTransport:
    ...
    def __init__(self, client: httpx.AsyncClient | None = None) -> None:
        # Keep one client for the lifetime of the transport.  Creating a client
        # per request defeats connection pooling and can exhaust sockets under
        # streaming workloads.  The default client is lazy so constructing a
        # provider does not bind it to an event loop that may not exist yet.
        self._client = client
