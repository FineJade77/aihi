...
from aihi.agent.plugins.errors import PluginIntegrityError, PluginManifestError
from aihi.agent.plugins.manifest import MANIFEST_FILENAME, PluginManifest, SemVer
...
class PluginDiscovery:
    ...
    def _content_hash(self, plugin_root: Path, manifest_path: Path) -> str:
        ...
        for path in plugin_root.rglob("*"):
            ...
            if relative.parts[0] in {".git", "__pycache__", ".aihi"}:
                continue
