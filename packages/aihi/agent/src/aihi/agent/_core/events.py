...
from aihi.agent._core.schema import EVENT_SCHEMA_VERSION, upgrade_event_payload
...
class Event:
    ...
    def persisted(self, seq: int) -> Event:
        return replace(self, data=copy.deepcopy(self.data), seq=seq, ephemeral=False)
